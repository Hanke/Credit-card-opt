module Recommendations
  class PurchaseParams
    ...
    validate :credit_card_ids_are_whole_numbers
    ...
    def credit_card_ids_are_whole_numbers
      errors.add(:credit_card_ids, "must be whole numbers") if credit_card_ids&.include?(nil)
    end
  end
end
