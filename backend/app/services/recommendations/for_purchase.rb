module Recommendations
  class ForPurchase
    ...
    def self.call(user:, amount:, category:, credit_card_ids: nil)
      new(user: user, amount: amount, category: category, credit_card_ids: credit_card_ids).call
    end

    def initialize(user:, amount:, category:, credit_card_ids: nil)
      @user = user
      @purchase = PurchaseParams.new(amount: amount, category: category, credit_card_ids: credit_card_ids)
    end
    ...
    def select_cards(wallet)
      selected = purchase.credit_card_ids
